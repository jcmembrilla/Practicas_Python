...
lista3 = ["Palabara", 1, 1.12, True] #Lista de tipos mixto /NO RECOMENTABLE/
...
#Importante recordar el indce 0 es la primera ubicacion, el primero lugar en la lista.
...
lista_de_listas = [[1,2],[3,4]]
print(lista_de_listas[1][0]) #Primero seleccionamos la lista y luego la ubicacion
